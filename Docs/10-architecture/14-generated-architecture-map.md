...
363 Python modules under `src/`, 2068 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 233 |
...
graph LR
  ...
  domain["aida domain modules<br/>233 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 338 |
...
Union of all five: 357 of 363 modules.
...
| aida domain modules | 218 | 72 | 118 | 33 | 6 | 233 |
...
graph LR
  ...
  aida_main(["aida.main<br/>338 reached"])
