...
357 Python modules under `src/`, 2019 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 229 |
...
graph LR
  ...
  domain["aida domain modules<br/>229 modules"]
...
Union of all five: 351 of 357 modules.
...
| aida domain modules | 214 | 72 | 115 | 33 | 6 | 229 |
...
| `aida.security` | aida domain modules | 111 |
