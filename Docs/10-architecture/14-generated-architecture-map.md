...
365 Python modules under `src/`, 2105 intra-`src` import edges.
...
| `aida.workflows.scheduler` | Fleet scheduler (polling loop) | 173 |
...
| aida domain modules | 219 | 73 | 124 | 33 | 6 | 235 |
...
graph LR
  ...
  aida_workflows_scheduler(["aida.workflows.scheduler<br/>173 reached"])
