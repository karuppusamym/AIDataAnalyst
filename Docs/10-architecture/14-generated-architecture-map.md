...
368 Python modules under `src/`, 2123 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 237 |
...
graph LR
  ...
  domain["aida domain modules<br/>237 modules"]
...
| `aida.workflows.scheduler` | Fleet scheduler (polling loop) | 177 |
...
Union of all five: 362 of 368 modules.
...
| aida domain modules | 220 | 73 | 127 | 33 | 6 | 237 |
...
graph LR
  ...
  aida_workflows_scheduler(["aida.workflows.scheduler<br/>177 reached"])
  ...
  only_aida_workflows_scheduler["only this process<br/>13 modules"]
