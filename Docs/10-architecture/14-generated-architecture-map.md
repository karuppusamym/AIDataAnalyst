...
444 Python modules under `src/`, 2755 intra-`src` import edges.
...
| aida.connectors | `aida.connectors.*` | 17 |
...
graph LR
  ...
  connectors["aida.connectors<br/>17 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 410 |
| `aida.workflows.worker` | Temporal worker | 134 |
| `aida.workflows.scheduler` | Fleet scheduler (polling loop) | 213 |
| `aida.projectors.graph_projector` | Lineage graph projector (Kafka consumer) | 92 |
| `aida.projectors.outbox_publisher` | Outbox publisher (Kafka producer) | 27 |

Union of all five: 436 of 444 modules.
...
| aida.connectors | 17 | 16 | 16 | 15 | 0 | 17 |
...
graph LR
  ...
  aida_main(["aida.main<br/>410 reached"])
  aida_workflows_worker(["aida.workflows.worker<br/>134 reached"])
  aida_workflows_scheduler(["aida.workflows.scheduler<br/>213 reached"])
  aida_projectors_graph_projector(["aida.projectors.graph_projector<br/>92 reached"])
