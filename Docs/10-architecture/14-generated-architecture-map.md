...
424 Python modules under `src/`, 2644 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 282 |
...
graph LR
  ...
  domain["aida domain modules<br/>282 modules"]
...
Union of all five: 418 of 424 modules.
...
| aida domain modules | 261 | 81 | 152 | 44 | 6 | 282 |
...
graph LR
  ...
  aida_main --> shared
  only_aida_main["only this process<br/>196 modules"]
