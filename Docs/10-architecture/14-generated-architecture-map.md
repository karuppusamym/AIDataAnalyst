...
425 Python modules under `src/`, 2648 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 283 |
...
graph LR
  ...
  domain["aida domain modules<br/>283 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 394 |
...
Union of all five: 419 of 425 modules.
...
| aida domain modules | 262 | 81 | 152 | 44 | 6 | 283 |
...
graph LR
  ...
  aida_main(["aida.main<br/>394 reached"])
...
|---|---|---:|
| `aida.models` | aida domain modules | 231 |
