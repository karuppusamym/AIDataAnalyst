...
441 Python modules under `src/`, 2729 intra-`src` import edges.
...
| aida routers (*_api) | flat `aida.*` whose filename ends `_api` | 76 |
| aida domain modules | everything else flat in `aida.*` | 296 |
...
graph LR
  ...
  routers["aida routers (*_api)<br/>76 modules"]
  domain["aida domain modules<br/>296 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 407 |
| `aida.workflows.worker` | Temporal worker | 133 |
| `aida.workflows.scheduler` | Fleet scheduler (polling loop) | 210 |
...
Union of all five: 433 of 441 modules.
...
| aida routers (*_api) | 76 | 0 | 3 | 1 | 0 | 76 |
| aida domain modules | 272 | 82 | 156 | 44 | 6 | 296 |
...
graph LR
  ...
  aida_main(["aida.main<br/>407 reached"])
  aida_workflows_worker(["aida.workflows.worker<br/>133 reached"])
  aida_workflows_scheduler(["aida.workflows.scheduler<br/>210 reached"])
...
|---|---|---:|
| `aida.models` | aida domain modules | 236 |
| `aida.security` | aida domain modules | 134 |
| `aida.schemas` | aida domain modules | 114 |
| `aida.db` | aida domain modules | 111 |
| `aida.config` | aida domain modules | 109 |
| `aida.events` | aida domain modules | 100 |
| `aida.context` | aida domain modules | 75 |
| `aida.envelope_models` | aida domain modules | 44 |
| `atlas.platform.config` | atlas.platform | 33 |
