...
| aida domain modules | everything else flat in `aida.*` | 236 |
...
graph LR
  ...
  domain["aida domain modules<br/>236 modules"]
...
| aida domain modules | 219 | 73 | 126 | 33 | 6 | 236 |
...
|---|---|---:|
| `aida.models` | aida domain modules | 200 |
