...
369 Python modules under `src/`, 2125 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 238 |
...
graph LR
  ...
  domain["aida domain modules<br/>238 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 341 |
| `aida.workflows.worker` | Temporal worker | 119 |
| `aida.workflows.scheduler` | Fleet scheduler (polling loop) | 178 |
...
Union of all five: 363 of 369 modules.
...
| aida domain modules | 220 | 73 | 128 | 33 | 6 | 238 |
...
graph LR
  ...
  aida_main(["aida.main<br/>341 reached"])
  aida_workflows_worker(["aida.workflows.worker<br/>119 reached"])
  aida_workflows_scheduler(["aida.workflows.scheduler<br/>178 reached"])
  ...
  only_aida_workflows_scheduler["only this process<br/>14 modules"]
...
|---|---|---:|
| `aida.models` | aida domain modules | 201 |
| `aida.security` | aida domain modules | 117 |
...
| `aida.envelope_models` | aida domain modules | 22 |
