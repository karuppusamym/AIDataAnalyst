...
362 Python modules under `src/`, 2061 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 232 |
...
graph LR
  ...
  domain["aida domain modules<br/>232 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 337 |
...
Union of all five: 356 of 362 modules.
...
| aida domain modules | 217 | 72 | 118 | 33 | 6 | 232 |
...
graph LR
  ...
  aida_main(["aida.main<br/>337 reached"])
  ...
  aida_main --> shared
  only_aida_main["only this process<br/>172 modules"]
...
|---|---|---:|
| `aida.models` | aida domain modules | 197 |
