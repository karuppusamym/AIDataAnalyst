...
433 Python modules under `src/`, 2684 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 291 |
...
graph LR
  ...
  domain["aida domain modules<br/>291 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 399 |
...
Union of all five: 425 of 433 modules.
...
| aida domain modules | 267 | 81 | 154 | 44 | 6 | 291 |
...
graph LR
  ...
  aida_main(["aida.main<br/>399 reached"])
...
| `aida.security` | aida domain modules | 133 |
| `aida.schemas` | aida domain modules | 113 |
| `aida.db` | aida domain modules | 109 |
| `aida.config` | aida domain modules | 106 |
...
| `aida.ingest_screening` | aida domain modules | 22 |
