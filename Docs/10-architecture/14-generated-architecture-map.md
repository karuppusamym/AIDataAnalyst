...
| aida domain modules | everything else flat in `aida.*` | 227 |
...
graph LR
  ...
  domain["aida domain modules<br/>227 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 329 |
...
Union of all five: 348 of 354 modules.
...
| aida domain modules | 212 | 70 | 115 | 33 | 6 | 227 |
...
graph LR
  ...
  aida_main(["aida.main<br/>329 reached"])
