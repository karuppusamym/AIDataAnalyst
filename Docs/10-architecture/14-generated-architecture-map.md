...
436 Python modules under `src/`, 2702 intra-`src` import edges.
...
| aida domain modules | everything else flat in `aida.*` | 293 |
...
graph LR
  ...
  domain["aida domain modules<br/>293 modules"]
...
|---|---|---:|
| `aida.main` | FastAPI application (`uvicorn aida.main:app`) | 402 |
...
Union of all five: 428 of 436 modules.
...
| aida domain modules | 269 | 81 | 154 | 44 | 6 | 293 |
...
graph LR
  ...
  aida_main(["aida.main<br/>402 reached"])
  ...
  aida_main --> shared
  only_aida_main["only this process<br/>204 modules"]
...
| `aida.sql_redaction` | aida domain modules | 15 |
