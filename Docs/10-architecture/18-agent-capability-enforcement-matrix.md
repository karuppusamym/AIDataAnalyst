...
Findings 4, 5, 11 and 12 were closed on 2026-09-12. What keeps AR-06 open now is finding
10 alone -- the native tools' missing allowlist, a contract-schema change rather than a
check -- stated with its reason above rather than left to be rediscovered. This page had fallen behind: it still called the reviewer gap
