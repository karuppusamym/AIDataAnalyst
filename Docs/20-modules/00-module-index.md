...
| [09](09-lineage.md) | lineage | L2 | Where data came from — and why the agent chose it | No | `unified_lineage.py`, `unified_lineage_api.py`, `lineage_cache.py`, `lineage_graph_store.py`, `openlineage.py`, `dbt_artifacts.py`. **No view-DDL, procedure or query-log parser exists** |
