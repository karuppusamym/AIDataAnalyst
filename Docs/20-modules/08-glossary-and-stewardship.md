...
| AG-12 | Steward agent: GL-8/GL-9 proposals under a contracted agent identity ([ADR-0029](../10-architecture/adr/ADR-0029-steward-agent.md)) | DONE - on-demand runs; no scheduler | P1 |
