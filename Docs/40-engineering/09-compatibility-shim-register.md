...
14 shims, 1177 shim-to-caller-file relationships across 574 distinct files, 0 shim(s) with a measured caller count of zero.

| Shim | Kind | Replacement path | Owner area | Callers | Import stmts | String refs |
|---|---|---|---|---:|---:|---:|
| [`aida.db`](#aidadb) | python | `atlas.platform.db` | Platform infrastructure | 318 | 323 | 2 |
| [`aida.config`](#aidaconfig) | python | `atlas.platform.config` | Platform infrastructure | 262 | 272 | 1 |
| [`aida.context`](#aidacontext) | python | `atlas.platform.context` | Platform infrastructure | 71 | 71 | 0 |
| [`aida.logging`](#aidalogging) | python | `atlas.platform.logging` | Platform infrastructure | 5 | 5 | 0 |
| [`aida.models`](#aidamodels) | python-partial | `atlas.modules.<context>.models` (re-exported classes only) | Bounded contexts (catalog, connectivity, identity_tenancy, ingestion, observability_audit, profiling) jointly | 456 | 567 | 2 |
...
- **Callers** — 318 file(s), 323 import statement(s)
  - By source root: `migrations` 1, `scripts` 8, `src/aida` 104, `src/atlas` 5, `tests` 200
...
- **Callers** — 262 file(s), 272 import statement(s)
  - By source root: `migrations` 1, `scripts` 5, `src/aida` 96, `src/atlas` 4, `tests` 156
...
- **Callers** — 71 file(s), 71 import statement(s)
  - By source root: `src/aida` 67, `src/atlas` 4
...
- **Callers** — 456 file(s), 567 import statement(s)
  - By source root: `scripts` 12, `src/aida` 170, `src/atlas` 7, `tests` 267
