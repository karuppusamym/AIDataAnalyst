...
| `mcp_client_allowed_hosts` | `list[str]` | `list` | 1 | Supplied: the hosts an upstream MCP server may live on; empty means none can be reached |
...
| `mcp_client_allowed_hosts` | `list[str]` | `list` | 1 |
| `mcp_client_timeout_seconds` | `int` | `15` | 1 |
