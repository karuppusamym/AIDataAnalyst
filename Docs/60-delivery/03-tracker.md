...
| CN-1c | BigQuery adapter to certified | 02 | A | P0 | TODO | — | Certification + version fixtures |
| CN-2 | Snowflake and Databricks adapters | 02 | A | P0 | TODO | — | Certification + version fixtures |
...
| RL-4 | Project approved relationships to Neo4j | 06/10 | A | P1 | TODO | — | Visible in graph explorer |
...
| LN-6 | dbt `run_results.json` operational evidence | 09 | B | P1 | TODO | — | Health and SLA signals |
...
| KG-1 | Project approved relationships | 10 | A | P1 | TODO | — | Same as RL-4 |
...
| MG-3 | Bank-approved route selection + private routing | 15 | B | P0 | TODO | — | Private endpoint; approved model ID |
...
| **CX-1** | **MCP server** | 19 | A | **P0** | TODO | — | Resources + tools, policy-evaluated |
| **CX-2** | **Context products with maker-checker** | 19 | A | **P0** | TODO | — | Versioned, owned, approved |
| **CX-3** | **Per-read policy evaluation** | 19 | A | **P0** | TODO | — | Every read, not only connection |
| **CX-4** | **Consumption as lineage** | 19 | A | **P0** | TODO | — | Edges recorded |
| **CX-5** | **Eligible-tool exposure + governed invocation** | 19 | A | **P0** | TODO | — | External invocation uses the same gateway |
...
| UX-5 | Accessibility audit and remediation | 21 | C | P1 | TODO | — | WCAG AA |
