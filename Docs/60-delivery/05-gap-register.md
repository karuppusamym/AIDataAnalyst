...
| P1 | **Lineage MCP tools** (CP-6 / EE.10) | Collibra ships upstream/downstream/impact as callable MCP tools; ours are REST-only, so an external agent cannot ask for lineage the way it can ask for catalog resources — `competitors/08-collibra-lineage-and-platform-analysis-2026-08.md` |
