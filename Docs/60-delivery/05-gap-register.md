...
| P2 | **Governed context compiler** (CP-5 / EE.9) | **Foundation closed 2026-08-29**: deterministic MCP/REST/YAML/OSI/ODCS/Snowflake/Databricks compilation and drift reporting are tested; idiomatic YAML, downloadable files, and external target validators remain |
| P2 | **Data product and data contract registries** (CP-2, CP-3 / EE.8) | **Foundation closed 2026-08-29**: product/contract lifecycle, breaking-change exception review, role-gated marketplace, and access-request workflow are implemented and tested; entitlement-provider fulfillment remains |
| P2 | **Unified AI registry and trust scoring** (CP-7, CP-8 / EE.11) | **Foundation closed 2026-08-29**: mounted lifecycle/assessment/trust APIs and explainable deterministic scoring are implemented and tested; managed templates, remediation/retirement, provider sync, score history, and dependency visualization remain |
