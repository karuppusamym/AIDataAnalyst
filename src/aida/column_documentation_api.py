...
`DocumentClaim`, workbook import batch or column description draft), and
adding a direct-write endpoint would be a way around the one gate that makes
the content trustworthy. See
