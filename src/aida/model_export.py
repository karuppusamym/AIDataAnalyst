...
def _readme_sheet(
    *,
    ...
    rows: list[list[CellValue]] = [
        ...
        # Read by the Excel add-in to address its save-back to the right tenant;
        # `Datasource id` above is what the import itself enforces.
        ["Organization id", str(datasource.organization_id)],
