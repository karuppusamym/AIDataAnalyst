"""Standalone self-check for the connectivity module scaffold.

Run in isolation with: `pytest src/atlas/modules/connectivity` (per the module
...
def test_public_surface_imports_cleanly() -> None:
    ...
    world.
    """
    api = importlib.import_module("atlas.modules.connectivity.api")
    contracts = importlib.import_module("atlas.modules.connectivity.contracts")
