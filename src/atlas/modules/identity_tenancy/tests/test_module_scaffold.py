"""Standalone self-check for the identity_tenancy module scaffold.

Run in isolation with: `pytest src/atlas/modules/identity_tenancy` (per the module
...
def test_public_surface_imports_cleanly() -> None:
    ...
    world.
    """
    api = importlib.import_module("atlas.modules.identity_tenancy.api")
    contracts = importlib.import_module("atlas.modules.identity_tenancy.contracts")
