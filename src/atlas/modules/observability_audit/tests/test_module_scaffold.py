"""Standalone self-check for the observability_audit module scaffold.

Run in isolation with: `pytest src/atlas/modules/observability_audit` (per the module
...
def test_public_surface_imports_cleanly() -> None:
    ...
    world.
    """
    api = importlib.import_module("atlas.modules.observability_audit.api")
    contracts = importlib.import_module("atlas.modules.observability_audit.contracts")
