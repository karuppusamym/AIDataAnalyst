"""Standalone self-check for the profiling module scaffold.

Run in isolation with: `pytest src/atlas/modules/profiling` (per the module
...
def test_public_surface_imports_cleanly() -> None:
    ...
    world.
    """
    api = importlib.import_module("atlas.modules.profiling.api")
    contracts = importlib.import_module("atlas.modules.profiling.contracts")
